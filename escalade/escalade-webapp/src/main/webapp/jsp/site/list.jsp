...
<div id="page">
    ...
    <div id="partieGauche"  class="col-lg-7 col-md-10 col-sm-12">
            ...
            <div class="card text-white "  id="bloc">
                ...
                <div class="card-body" style="display: flex;">
                    <div id="divImage" class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                        <img src="./image/toulon2.jpg" width="100%" height="100%" id="img" style="border: 1px black solid;" />
                    </div>
        ...
        <s:if test="nombre == 5">
            <s:a id ="pageUp" action="site_valide_list_pageUp" class="btn btn-info"><s:param name="lastId" value="lastId" /> Page suivante </s:a>
        </s:if>
        <s:if test="firstPage != true">
            <s:a id ="pageDown" action="site_valide_list_pageUp" class="btn btn-info"><s:param name="lastId" value="lastId" /> Page précedente </s:a>
        </s:if>
    </div>
